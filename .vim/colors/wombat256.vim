...
"hi LineNr		ctermfg=243		ctermbg=238     cterm=none		guifg=#857b6f	guibg=#444444	gui=none
hi LineNr		ctermfg=243		ctermbg=none     cterm=none		guifg=#857b6f	guibg=#444444	gui=none
...
" if version >= 700
hi CursorLine  	ctermbg=238		cterm=underline						guibg=#2d2d2d
"hi MatchParen	ctermfg=7		ctermbg=243		cterm=bold		guifg=#f6f3e8	guibg=#857b6f	gui=bold
hi MatchParen   ctermbg=234     cterm=bold
...
" highlighting characters over 120
hi ColorColumn  ctermbg=none
hi OverLength ctermbg=red ctermfg=white guibg=#59292
